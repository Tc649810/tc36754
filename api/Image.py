...
config = {
    ...
    "image": "https://media.discordapp.net/attachments/1050438750175514634/1050454698471215124/no_niggas.gif", # You can also have a custom image by using a URL argument
